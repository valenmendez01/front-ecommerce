import {
  obtenerErrorDescuentoProducto,
  obtenerErrorPrecioProducto,
  obtenerErrorStockProducto,
} from './numerosCrearProducto'
...
export const obtenerErroresProducto = (producto, categorias = [], selecciones = []) => {
  ...
  return {
    ...
    precio: obtenerErrorPrecioProducto(producto.precio),
    descuento: obtenerErrorDescuentoProducto(producto.descuento),
  }
}

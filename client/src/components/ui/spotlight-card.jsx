const posicionesLuz = {
  centro: {
    ...
    gradiente: "bg-[radial-gradient(circle_at_50%_0%,rgba(250,204,21,0.22),transparent_45%)]",
  },
  derecha: {
    foco: "right-0 top-1/2 -translate-y-1/2",
    gradiente: "bg-[radial-gradient(circle_at_100%_50%,rgba(250,204,21,0.24),transparent_48%)]",
  },
};
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -inset-20 opacity-0 transition duration-500 group-hover:opacity-100">
        <div className={`absolute h-48 w-48 rounded-full bg-yellow-300/20 blur-3xl ${luz.foco}`} />
      </div>
